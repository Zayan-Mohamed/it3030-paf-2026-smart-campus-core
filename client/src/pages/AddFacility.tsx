...
import { FacilityType, FacilityStatus, CreateFacilityRequest } from '../types';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || JSON.stringify(errorData.details) || 'Failed to create facility');
      }
